...
export default function Projects() {
    <tbody>
                        <tr>
                            <td className='py-4 pr-10 align-top font-bold text-3xl'>Experience</td>
                            <td className='p-4'>
                                <ul className="list-none align-right">
                                    <li className='pb-8'>
                                        <span className='text-xl block text-light-blue b-1'>
                                            Software Engineer Intern @ The Cigna Group
                                        </span>
                                        <text >
                                            ...
                                            <br /><br />
                                            This new architecture saves over <span className="font-bold">2,500 hours of pipeline run time </span> per development team per sprint, and significantly reduces the time spent reviewing reports!
                                        </text>
                                    </li>
                                    <li className='pb-8'>
                                        <span className="text-xl block text-light-blue pb-1">
                                            Course Manager/Assistant @ University of Colorado Boulder
                                        </span>
                                        <text>
                                            ...
                                            I give many thanks to my professor, <Link href={'https://www.linkedin.com/in/malofquist/'} className='underline hover:text-light-blue hover:no-underline'>Mark Lofquist</Link>, for inspiring my new-found passion in wireless communication and networks as a whole.
                                            <br /><br />
                                            ...
                                            <br /><br />
                                            I developed and released a Python package on PyPi, <Link href={'https://pypi.org/project/simple-latex-checker/'} className='underline hover:text-light-blue hover:no-underline'>simple-latex-checker</Link> designed to address the most common issue students encounter when converting their Jupyter Notebooks to PDFs: erroneous spaces in their inline LaTeX.
                        ...
                        <tr>
                            <td className='py-4 pr-10 align-top font-bold text-xl'>Education</td>
                            <td className='p-4'>
